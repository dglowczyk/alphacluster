...
5. **Multi-component reward function** (8 components):
   ...
   - Position management reward (sqrt ramp for winners up to 3x, escalating penalty for losers at time/30 rate)
   - Trade completion reward (quadratic duration/30 scaling for winners, inverse for losers)
   - Churn penalty (penalizes trades held fewer than 50 steps, base 0.05, quadratic)
...
6. **Curriculum learning** (3 phases):
   ...
   - Phase 3 (60-100%): "Refine & Exploit" — low entropy (0.01), opportunity_cost_scale=0.3, amplified fee (2.0x) and churn (2.0x) penalties
